...
Equal values receive the same rank, and the next rank is skipped.
...
Where as in the second ranking type;
2. Dense Ranking

Equal values also receive the same rank, but no rank is skipped.
